...
from databaseHandler import connect_to_database, query_and_get_data, add_daily_sale
...
def main():
    global db_connection, window, entry_var_1, entry_var_2, entry_var_3, entry_var_4

    # Connect to the MySQL database
    db_connection = connect_to_database("127.0.0.1", "root", "123", "shopinas_database")

    window = Tk()
    window.geometry("607x345+450+270")
